          ...
          <Table.Body>
            {jobs.map((jobs) => (
              <Table.Row key="{jobs.id}">
                <Table.Cell>
                  {" "}
                  <Segment>{String(jobs.cityName)}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{String(jobs.companyName)}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{jobs.jobTitle}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{jobs.position}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{jobs.date}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{jobs.minSalary}</Segment>
                </Table.Cell>
                <Table.Cell>
                  <Segment>{jobs.maxSalary}</Segment>
                </Table.Cell>
                <Table.Cell
                  className={String(jobs.jobOpen) === "true" ? "add" : "don't"}
                >
